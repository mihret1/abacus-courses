...
function Footer() {
  return (
    ...
    <div className='grid grid-cols-3  max-sm:grid-cols-1 sm:max-mdd:grid-cols-2 px-5 justify-center   gap-8 py-10 bg-[#000D1D] text-white  '>
        <div className='flex flex-col gap-3 max-sm:w-[340px] ' >
            <a href="/"> <div className="flex gap-1 items-center">  <img src={logo}  className="w-20 h-16 "/> <span className={`text-2xl max-sm:text-lg  font-bold  `}>Eagle Training Center</span> </div></a>
        ...
        <div className='text-xl flex flex-col  items-center '>
           <div className='flex flex-col gap-2   '>
              <p className='text-2xl pb-1'>Work Opportunities</p>
        ...
        <div className=' text-xl flex flex-col  items-center '>
           <div className='flex flex-col   '>
              <p className='text-3xl'>Opportunities</p>
              <p><TaskAltIcon /> Online Shopping</p>
              <p><TaskAltIcon /> Paid Adversitment</p>
              <p><TaskAltIcon /> Upwork</p>
              <p><TaskAltIcon /> Drop shipping</p>
